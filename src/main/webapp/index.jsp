...
<%--	<script type='text/javascript' src='<%=path %>/dwr/util.js'></script>--%>
	...
	<script language="javascript">
		function check1()
		{
			...
			if(document.ThisForm.userName.value=="") // ThisForm是一个表单名，userName是表单里的元素
			{
				alert("请输入用户名");
				document.ThisForm.userName.focus(); // focus是光标定位到这的意思
				return false;
			}
			...
			document.getElementById("indicator").style.display="block"; // 登录的图片锁定
...
<br>
<br>
<table width="559" height="400" border="0" align="center" cellpadding="0" cellspacing="0"  style="background-color: #FFFFFF">
	<tr>
		<td><div align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 40pt;">个人时间管理系统</div></td>
	</tr>
	<tr>
		<td width="559">
			<form name="ThisForm" method="POST" action="./userLogin" id="adminLogin">
				<table width="410" height="198" border="0" align="right" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td width="356" valign="bottom">
							<input name="userName"  id= "inputName" type="text" class="input2" onMouseOver="this.style.background='#F0DAF3';" onMouseOut="this.style.background='#FFFFFF'" style="width: 141px;">
					...
					<tr>
						<td colspan="2" valign="top">&nbsp; &nbsp; &nbsp; &nbsp;
							...
							<input name="Submit2" type="button" class="submit1" onclick="javascript:location.href='userReg.jsp'" value="用户注册">
