...
<form action="<%=path%>/querySchedule" method="get">
    <input name="type" type="hidden" value="date">
    <table width="98%" border="0" cellpadding="2" cellspacing="1" align="center" style="margin-top:8px">
        <tr>
            <td>
                截止时间从：<input name="begin" value="${begin}" class="Wdate" type="text" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/>
                至：<input name="end" value="${end }" class="Wdate" type="text" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/>
