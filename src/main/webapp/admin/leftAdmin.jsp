...
<div class="container">
	<div class="leftsidebar_box">
		...
		<dl class="custom">
			...
			<dd><a href="${path}/delUser" id="4" class="handle-view">&emsp;删除用户&emsp;&emsp;&emsp;</a></dd>
			<dd><a href="${path}/index.jsp" id="5" class="handle-view" onclick="relogin()">&emsp;管理员注销登录&emsp;&emsp;&emsp;</a></dd>
		</dl>
