package com.pers.ScheduleSystem.api.common.exception;


import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
//import edu.nwpu.onlinedoc.api.common.respond.CommonResult;
//import edu.nwpu.onlinedoc.application.common.exception.*;
//import edu.nwpu.onlinedoc.utils.exception.ForbiddenException;
//import edu.nwpu.onlinedoc.utils.exception.NoAuthException;
//import edu.nwpu.onlinedoc.utils.exception.NotFoundException;
import com.pers.ScheduleSystem.api.common.respond.CommonResult;
import com.pers.ScheduleSystem.service.common.exception.BusinessException;
import com.pers.ScheduleSystem.service.common.exception.ExceptionType;
import com.pers.ScheduleSystem.utils.exception.ForbiddenException;
import com.pers.ScheduleSystem.utils.exception.NoAuthException;
import com.pers.ScheduleSystem.utils.exception.NotFoundException;
import lombok.Data;
 ...
 * @version 1.0
 */
// @Slf4j相当于代替了以下的代码：private  final Logger logger = LoggerFactory.getLogger(当前类名.class)
// @RestControllerAdvice = 由@ControllerAdvice、@ResponseBody组成
@Slf4j
@RestControllerAdvice
public class GlobalExceptionHandler {

    @Autowired
    private ObjectMapper objectMapper;  // 使用Jackson解析JSON最简单的方法
